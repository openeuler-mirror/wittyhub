...
<template>
  ...
  >
    ...
    <div class="flex w-[100px] text-sm text-gray-500 dark:text-gray-400 items-center justify-start gap-1">
    ...
    <div class="w-36 text-left text-sm text-gray-500 truncate dark:text-gray-400" :title="skill.author || '-'">
      {{ skill.author || '-' }}
    </div>
  </RouterLink>
</template>
