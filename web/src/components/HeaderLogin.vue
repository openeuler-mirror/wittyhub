...
const goLogin = () => {
  const origin = import.meta.env.VITE_LOGIN_ORIGIN || 'https://id.openeuler.openatom.cn'
  const url = `${origin}/login?redirect_uri=${encodeURIComponent(location.href)}&lang=zh`
