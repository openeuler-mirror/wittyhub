  ...
  >
    ...
    <div class="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700 flex-shrink-0 skill-card-footer">
      <div class="flex items-center gap-3">
        ...
        <div v-if="skill.stars_count > 0" class="flex items-center gap-1">
          <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2.5L14.9 8.6L21.5 9.5L16.8 14.1L17.9 20.7L12 17.6L6.1 20.7L7.2 14.1L2.5 9.5L9.1 8.6L12 2.5Z"/>
          </svg>
          <span>{{ skill.stars_count.toLocaleString() }}</span>
        </div>
      </div>
      <div class="flex items-center gap-1">
